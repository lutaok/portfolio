...
const Hero: Component = () => {
  return (
    <div class="flex grow flex-col gap-8 text-center">
      <h1 id="about" class="bg-gradient-to-r from-white to-primary-500 bg-clip-text text-5xl text-black text-opacity-0">
        Hello, I'm Lutaok
      </h1>
      <p>Experienced Front End Engineer specilized in crafting fast and efficient user interfaces.</p>
      <Skills />
